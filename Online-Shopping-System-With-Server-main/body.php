		...
		<div class="section mainn mainn-raised">
			...
			<div class="container">
				...
				<div class="row">
					...
					<!-- shop -->
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=18"><div class="shop">
							<div class="shop-img">
								<img src="./img/shop02.png" alt="">
							</div>
							<div class="shop-body">
								<h3>Housing<br>Collection</h3>
								<a href="product.php?p=18" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					$product_query = "SELECT * FROM products INNER JOIN categories ON products.product_cat = categories.cat_id WHERE product_id BETWEEN 70 AND 75";
