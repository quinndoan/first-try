...
ALTER DATABASE CDQ SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE CDQ SET ANSI_NULLS ON 
GO
ALTER DATABASE CDQ SET ANSI_PADDING ON 
GO
ALTER DATABASE CDQ SET AUTO_CLOSE ON 
GO
ALTER DATABASE CDQ SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE CDQ SET RECURSIVE_TRIGGERS OFF
GO
ALTER DATABASE CDQ SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE CDQ SET  MULTI_USER 
GO
...
INSERT admin_info (admin_id, admin_name, admin_email, admin_password) VALUES (1, N'admin', N'cdq@gmail.com', N'Cdq@123321')
...
INSERT orders_info (order_id, user_id, f_name, email, address, city, state, zip, cardname, cardnumber, expdate, prod_count, total_amt, cvv) VALUES (1, 12, N'BK', N'help.bk@gmail.com', N'BachKhoa, HaiBaTrung, HaNoi', N'BK', N'BK', 560074, N'pokjhgfcxc', N'4321 2345 6788 7654', N'12/90', 3, 77000, 1234)
...
VALUES
	(12, N'Cuong', N'Tran', N'cuong@apricotstore.com', N'cuong', N'8448121558', N'Hanoi', N'Soc Son'),
	(15, N'Duyen', N'Nguyen', N'duyen@apricotstore.com', N'duyen', N'8436487276', N'Quangninh', N'Halong'), 
	(16, N'Quyen', N'Doan', N'quyen@apricotstore.com', N'quyen', N'8487765433', N'Hanoi', N'Hoan Kiem'), 
	(19, N'Minh', N'Tung', N'minh@apricotstore.com', N'minh', N'8497123653', N'Hanoi', N'Thanh Xuan'), 
	(21, N'Han', N'Gia', N'han@apricotstore.com', N'han', N'8494751042', N'Hanoi', N'Ba Dinh'); 
SET IDENTITY_INSERT user_info OFF


SET IDENTITY_INSERT user_info_backup ON 
...
VALUES
	...
	(19, N'Minh', N'Tung', N'minh@apricotstore.com', N'minh', N'8497123653', N'Hanoi', N'Thanh Xuan'), 
	(21, N'Han', N'Gia', N'han@apricotstore.com', N'han', N'8494751042', N'Hanoi', N'Ba Dinh'); 
SET IDENTITY_INSERT user_info_backup OFF
